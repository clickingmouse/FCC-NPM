  ...
  */
  ...
  var server = net.createServer(function (socket) {  
       ...
       var month = twoDigitStr(d.getMonth()+1);
       var date = twoDigitStr(d.getDate());
       //var hour =twoDigitStr(d.getDate());
       var hour = twoDigitStr(d.getHours());
       var minute = twoDigitStr(d.getMinutes());
       
       var date = d.getFullYear()+"-"+ month +"-"+ date+" "+hour+":"+minute;
